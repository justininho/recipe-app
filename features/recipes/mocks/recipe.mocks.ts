...
export const MOCK_RECIPES: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { name: 'Pecorino Romano, grated', amount: 60, unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'chicken breast, thinly sliced', amount: 300, unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'romaine lettuce, chopped', amount: 2, unit: '' },
      { name: 'Parmesan, shaved', amount: 40, unit: 'g' },
      { name: 'croutons', amount: 60, unit: 'g' },
      { name: 'garlic clove', amount: 1, unit: '' },
      { name: 'anchovy fillets', amount: 2, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'chili powder', amount: 1.5, unit: 'tsp' },
      { name: 'cumin', amount: 1, unit: 'tsp' },
      { name: 'smoked paprika', amount: 0.5, unit: 'tsp' },
      { name: 'salt', amount: 0.5, unit: 'tsp' },
      { name: 'shredded cheddar', amount: 80, unit: 'g' },
      { name: 'shredded lettuce', amount: 60, unit: 'g' },
      { name: 'diced tomato', amount: 1, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'pizza dough ball', amount: 250, unit: 'g' },
      { name: 'crushed San Marzano tomatoes', amount: 120, unit: 'ml' },
      { name: 'fresh mozzarella, torn', amount: 150, unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'vegetable oil', amount: 2, unit: 'tbsp' },
      { name: 'garlic cloves, minced', amount: 2, unit: '' },
      { name: 'crushed roasted peanuts', amount: 40, unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'unsalted butter, softened', amount: 225, unit: 'g' },
      { name: 'granulated sugar', amount: 100, unit: 'g' },
      { name: 'brown sugar, packed', amount: 200, unit: 'g' },
      { name: 'eggs', amount: 2, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'English cucumber, chopped', amount: 1, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'garlic clove, minced', amount: 1, unit: '' },
      { name: 'fresh ginger, grated', amount: 0.5, unit: 'tsp' },
      { name: 'sesame oil', amount: 1, unit: 'tsp' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'long-grain white rice', amount: 300, unit: 'g' },
      ...
      { name: 'cherry tomatoes, halved', amount: 150, unit: 'g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'baking soda', amount: 1, unit: 'tsp' },
      { name: 'salt', amount: 0.5, unit: 'tsp' },
      { name: 'unsalted butter, melted', amount: 75, unit: 'g' },
      { name: 'granulated sugar', amount: 150, unit: 'g' },
      { name: 'egg, beaten', amount: 1, unit: '' },
      { name: 'vanilla extract', amount: 1, unit: 'tsp' },
      { name: 'sour cream or yogurt', amount: 60, unit: 'ml' },
    ],
    instructions: [
      {
        id: 'i12-1',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'galangal or ginger, sliced', amount: 4, unit: '' },
      { name: 'kaffir lime leaves', amount: 4, unit: '' },
      { name: 'Thai red chilies, sliced', amount: 3, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'ciabatta roll', amount: 1, unit: '' },
      { name: 'fresh mozzarella, sliced', amount: 100, unit: 'g' },
      { name: 'ripe tomato, sliced', amount: 1, unit: '' },
      { name: 'fresh basil leaves', amount: 6, unit: '' },
      { name: 'extra virgin olive oil', amount: 1, unit: 'tbsp' },
      { name: 'balsamic glaze', amount: 1, unit: 'tsp' },
      { name: 'flaky sea salt', amount: 0.25, unit: 'tsp' },
      { name: 'black pepper', amount: 0.25, unit: 'tsp' },
    ],
    instructions: [
      {
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'BBQ sauce', amount: 240, unit: 'ml' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'chickpeas, drained', amount: 200, unit: 'g' },
      { name: 'baby spinach', amount: 60, unit: 'g' },
      { name: 'avocado, sliced', amount: 1, unit: '' },
      { name: 'red cabbage, shredded', amount: 60, unit: 'g' },
      { name: 'olive oil', amount: 3, unit: 'tbsp' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'large shrimp, peeled and deveined', amount: 400, unit: 'g' },
      ...
      { name: 'salt', amount: 0.5, unit: 'tsp' },
      { name: 'black pepper', amount: 0.25, unit: 'tsp' },
      { name: 'fresh parsley, chopped', amount: 15, unit: 'g' },
    ],
    instructions: [
      {
        id: 'i17-1',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'mixed mushrooms, sliced', amount: 400, unit: 'g' },
      { name: 'vegetable stock, warm', amount: 1.2, unit: 'l' },
      ...
      { name: 'fresh thyme', amount: 3, unit: '' },
      { name: 'salt', amount: 1, unit: 'tsp' },
      { name: 'black pepper', amount: 0.5, unit: 'tsp' },
    ],
    instructions: [
  ...
  },
  {
    ...
    ingredients: [
      { name: 'flour tortillas (large)', amount: 2, unit: '' },
      { name: 'cooked chicken breast, shredded', amount: 200, unit: 'g' },
      { name: 'shredded Mexican cheese blend', amount: 120, unit: 'g' },
      { name: 'red bell pepper, diced', amount: 0.5, unit: '' },
      { name: 'green onions, sliced', amount: 2, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Granny Smith apples, peeled and sliced', amount: 6, unit: '' },
      { name: 'granulated sugar', amount: 150, unit: 'g' },
      { name: 'brown sugar', amount: 2, unit: 'tbsp' },
      ...
      { name: 'refrigerated pie crusts', amount: 2, unit: '' },
      { name: 'unsalted butter, cubed', amount: 30, unit: 'g' },
      { name: 'egg, beaten', amount: 1, unit: '' },
      { name: 'coarse sugar for topping', amount: 1, unit: 'tbsp' },
    ],
    instructions: [
      {
        id: 'i20-1',
  ...
  },
  {
    ...
    ingredients: [
      { name: 'flat rice noodles', amount: 400, unit: 'g' },
      { name: 'beef sirloin, thinly sliced', amount: 300, unit: 'g' },
      { name: 'beef broth', amount: 2, unit: 'l' },
      { name: 'cinnamon stick', amount: 1, unit: '' },
      { name: 'star anise', amount: 3, unit: '' },
      { name: 'cloves', amount: 3, unit: '' },
      { name: 'yellow onion, halved', amount: 1, unit: '' },
      { name: 'fresh ginger, sliced', amount: 30, unit: 'g' },
      { name: 'fish sauce', amount: 3, unit: 'tbsp' },
      { name: 'sugar', amount: 1, unit: 'tsp' },
      { name: 'bean sprouts', amount: 80, unit: 'g' },
      { name: 'fresh Thai basil', amount: 20, unit: 'g' },
      { name: 'lime, cut into wedges', amount: 1, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'yellow onion, roughly chopped', amount: 0.5, unit: '' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'strong espresso or coffee, cooled', amount: 240, unit: 'ml' },
